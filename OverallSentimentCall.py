...
def send_request():
    # Overall sentiment request
    # POST http://gateway-a.watsonplatform.net/calls/text/TextGetTextSentiment
    ...
    try:
        response = requests.post(
            ...
            data={
                ...
                # ----------- Change text field to the content of the news piece... ----------------------
...
# ^ Call the function...
# In the response ----------------------------------------------
# status in the response will contain either OK or ERROR, indicating whether the request was processed
